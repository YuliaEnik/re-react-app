...
export const Countries = () => {
  ...
  const handleSort = useCallback((type: 'population' | 'name') => {
    setIsSorted(true);
    setSortOrder((prevOrder) => (type === sortBy ? (prevOrder === 'asc' ? 'desc' : 'asc') : 'asc'));
    setSortBy(type);
  }, [sortBy]);
  ...
  const sortedCountries = useMemo(() => {
    return isSorted 
      ...
      : filteredCountries;
  }, [filteredCountries, isSorted, sortBy, sortOrder]);
